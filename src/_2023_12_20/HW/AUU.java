...
public class AUU {
    public static void main(String[] args) {
        List<Player> allPlayers = createPlayers(250);

        // Создание команд
        List<Team> teams = createTeams(allPlayers, 50);
    ...
    // так как при большом количестве команд пришлось много прокручивать экран
